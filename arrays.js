...
const otherMarks = [
  ...
  {
    symbol: 'ฯลฯ',
    description: "Thai's equivalent to 'etc.', shorthand for indicating more similar items follow in a list.",
    words: []
  },
  {
    symbol: '๚',
    description: 'Marks the end of a section, chapter, or verse, essentially a "double separator."',
    words: []
  },
  {
    symbol: 'ฯ',
    description: 'An abbreviation character, used to signify a word has been shortened, like in the abbreviated name for Bangkok.',
    words: []
  },
  {
    symbol: '๏',
    description: 'Denotes the start of a new paragraph, often called "chicken’s eyes" and used in traditional or poetic texts.',
    words: []
  },
  {
    symbol: '๛',
    description: 'Represents the end of a text, primarily used in older passages or religious writings.',
    words: []
  },
  {
    symbol: '◌๎',
    description: 'The character "◌๎" is known as "Yamakkan" in the Thai script. It is a diacritic used in the Thai script that specifically marks the beginning of a consonant cluster. In Thai writing, consonant clusters are sequences of consonants without intervening vowels. The Yamakkan is placed above the initial consonant of the cluster to indicate its presence.',
    words: []
  },
  {
    symbol: '◌ฺ',
    description: "The PHINTHU mark, when placed below a consonant, signifies that the consonant should be pronounced without any subsequent vowel sound. While it's primarily used in dictionaries to clarify pronunciation, in the scripts of Thailand's minority languages, it denotes a non-Thai pronunciation. Essentially, this diacritic alters the sound of the consonant it accompanies.",
    words: []
  }
